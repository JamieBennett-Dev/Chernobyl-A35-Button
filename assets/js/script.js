...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const alarmSound = new Audio('/Chernobyl-A35-Button/assets/sounds/Nuclear-Alarm.mp3'); // Path to your alarm sound file
    const explosionSound = new Audio('/Chernobyl-A35-Button/assets/sounds/Nuclear-Explosion.mp3'); // Path to your explosion sound file
